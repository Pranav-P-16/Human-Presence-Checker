...
try:
    ...
    def mn():
        sg.theme("Topanga")
        st="N"
        layout1=[[sg.Text("\nHUMAN PRESENCE",font=("Helvetica",20))],[sg.Text("CHECKER\n",font=("Helvetica",20))],[sg.Button("Start",font=("Helvetica",20),button_color=("black","green"),size=(100,1),bind_return_key=True)],
                 [sg.Button("Help",button_color=("black","orange"),font=("Helvetica",20),size=(100,1),bind_return_key=True)],
                 [sg.Button("About",font=("Helvetica",20),size=(100,1),button_color=("black","lightblue"),bind_return_key=True)],
                 [sg.Button("Exit",font=("Helvetica",20),size=(100,1),button_color=("black","red"),bind_return_key=True)],
                 [sg.Text("\nVersion 1.0.1")]]
        window1=sg.Window("Human Presence Checker",layout1,size=(390, 400),element_justification="c")
